...
def DailyDbPullAssetData():
    ...
    # copy asset
    assetFilePath4296 = "{}/assetdata/assetdata_105150004296_{}_am.txt".format(srcDir, yyyymmdd) 
    ...
    assetFilePaths = [assetFilePath0175, assetFilePath0176, assetFilePath4096, assetFilePath0346, assetFilePath4289, assetFilePath4295, assetFilePath4427, assetFilePath4617,assetFilePath4296]
    for assetFile in assetFilePaths:
        task = pexpect.spawn(command="rsync -ruvzn wuwz@139.196.125.29:{} {}/positiondata/{}".format(assetFile, aimDir,yyyymmdd), timeout=None)
