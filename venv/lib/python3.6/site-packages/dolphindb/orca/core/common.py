...
def _warn_unimplemented_args(func):
    warnings.warn(f"Some arguments unimplemented by Orca has been passed "
                  f"to {func}, and it will behave as if a default value "
                  f"is given.", UnimplementedArgsWarning)
...
class UnimplementedArgsWarning(Warning):
    pass
